class BibliographiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bibliography.save
        format.html { redirect_to blog_url(@bibliography.blog), notice: "Se creó la referencia correctamente." }
  ...
  def update
    respond_to do |format|
      if @bibliography.update(bibliography_params)
        format.html { redirect_to blog_url(@bibliography.blog), notice: "Se editó la referencia correctamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to blog_url(blog), notice: "Se borró la referencia correctamente." }
